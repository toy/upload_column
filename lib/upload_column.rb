...
module UploadColumn
  ...
  DEFAULT_OPTIONS = {
    ...
    :store_dir => proc{|inst, attr| File.join((inst.class).to_s.underscore, attr.to_s, inst.id.to_s) },
    :tmp_dir => proc{|inst, attr| File.join((inst.class).to_s.underscore, attr.to_s, "tmp") },
    :old_files => :delete,
